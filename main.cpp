   ...
   // :表示继承  ：： 表示作用域  <<拼接
    QLabelClock(QWidget *parent)  :  QLabel(parent)
    {
        this->setText(QDateTime::currentDateTime().toString("yyyy-MM-dd hh:mm:ss zzz"));
         this->setStyleSheet("font-siza；25px");
               //创建定时器
...
//QWidgetSerialTx xinlvjisuan();
    ...
    QWidgetDraw *draw = new QWidgetDraw();
  //  QWidget *draw = new QWidget();

    //修改界面标题
 //   winMain->setWindowTitle("作业");
   //创建标签
    QLabel *tempText = new QLabel();
    tempText->setText("东软实习加油！");

    //设置父亲对象
    tempText ->setParent(draw);
    //设置显示位置
    tempText->setGeometry(50,400,500,50);

    QLabel *tempData = new QLabel(draw);
    tempData->setText("电子5班火箭团队！");
    //设置样式表
    tempData->setStyleSheet("color:red;font-size: 20px");
    //设置位置
    tempData->setGeometry(0,0,600,150);

    QLabel *tempDate = new QLabel(draw);
    tempDate->setText("东软实习加油！");
    //设置样式表
     draw->setStyleSheet("background-color:white;color:blue;font-size: 30px");
    //设置位置
    tempDate->setGeometry(200,0,500,100);

 QLabelClock *clock = new QLabelClock(draw);
 clock->setGeometry(0,100,500,150);

 QPainter *painter = new QPainter();
 painter->drawLine(0,0,75,75);
 painter->drawRect(0,0,75,75);

    draw->setStyleSheet("background-color:white;color:black;font-size: 40px");
    draw->resize(500,250);
...
//画图
    ...
    QWidgetSerialTx  *serialTx = new QWidgetSerialTx(); //串口设置
...
<<<<<<< HEAD
    QLabel *patientDev = new QLabel();
      ...
      layoutMain->addWidget(patientDev);
    ...
    drawWidgetEcg->setLabelText("ECG  I");
     drawWidgetEcg->setStyleSheet("font-size:40px;background-color: black;color:red");
        drawWidgetSpo->setLabelText("Spo");
         drawWidgetSpo->setStyleSheet("font-size:40px;background-color: black;color:green");
        drawWidgetIbp->setLabelText("Ibp");
         drawWidgetIbp->setStyleSheet("font-size:40px;background-color: black;color:pink");


        QLabel *widgetHr = new QLabel();
        QLabel *widgetNihp = new QLabel();
        QLabel *widgetHr2= new QLabel();
        QLabel *btnUp2 = new QLabel();
        QLabel *btnDown2 = new QLabel();
        QLabel *btnUp = new QLabel();
        QLabel *btnDown = new QLabel();
        QLabel *docTime = new QLabel();

        widgetHr->setText("HR:    70");//心率
         widgetHr->setStyleSheet("font-size:30px;color:green;background-color: black");
         widgetHr2->setText("ST:  -?-");
          widgetHr2->setStyleSheet("font-size:30px;color:pink;background-color: black");
          widgetNihp->setText("NIBP: -108-mmHg");//血压
           widgetNihp->setStyleSheet("font-size:30px;color:blue;background-color: black");
           btnUp->setText("SPO2: 98%");//血氧饱和度
            btnUp->setStyleSheet("font-size:30px;color:red;background-color: black");
            btnUp2->setText("T - 36.5  ℃");//温度
             btnUp2->setStyleSheet("font-size:30px;color:purple;background-color: black");
             btnDown->setText("RESP  -16- bpm");//呼气次数
              btnDown->setStyleSheet("font-size:30px;color:yellow;background-color: black");
              btnDown2->setText("CO2 -350-  mmHg");//二氧化碳浓度
               btnDown2->setStyleSheet("font-size:30px;color:yellow;background-color: black");
               docTime->setText("Patient state :\n"
                                " healthy");//健康状况
                docTime->setStyleSheet("font-size:30px;color:white;background-color: black");

          QVBoxLayout *widgetHrLay = new QVBoxLayout();
          //QHBoxLayout *btnUpLay = new QHBoxLayout();
          //QHBoxLayout *btnDownLay = new QHBoxLayout();
          widgetHrLay->addWidget(widgetHr);
          widgetHrLay->addWidget(widgetNihp);
          widgetHrLay->addWidget(btnUp);
          widgetHrLay->addWidget(btnDown);
...
<<<<<<< HEAD
        ...
        layoutLabelAndBtn->addWidget(btnDown2);

//        QLabel *patientDev = new QLabel();
  //        patientDev->setText("设备： xd001    备注：001");
    //      patientDev->setStyleSheet("color: green");
     //     layoutMain->addWidget(patientDev);
          layoutMain->setStretchFactor(patientDev,1);
          layoutMain->setStretchFactor(drawWidgetSpo,4);
          layoutMain->setStretchFactor(drawWidgetEcg,4);
          layoutMain->setStretchFactor(drawWidgetIbp,4);
          mainWin->setStyleSheet("background-color: white");
          mainWin->setWindowTitle("火箭团队");
...
<<<<<<< HEAD
        ...
        layoutMain1->setStretchFactor(layoutMain,6);
        layoutMain1->setStretchFactor(widgetHrLay,1);
        layoutMain1->setStretchFactor(layoutLabelAndBtn,1);

        //layoutMain1->setStretch(0,1);
        //layoutMain1->setStretch(layoutMain,1);
        //layoutMain1->setStretch(layoutMain,1);
