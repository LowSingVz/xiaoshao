    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(mServer, SIGNAL(newConnection()), this, SLOT(tcpNewnewConnect()));//2
...
void MainWindow::tcpNewnewConnect()
{
    mSocket = mServer->nextPendingConnection();
    if(mSocket)
    {
...
void MainWindow::on_pushButton_2_clicked()
{
     ...
     connect(mServer, SIGNAL(newConnection()), this, SLOT(tcpNewnewConnect()));
   // MainWindow1 b;
   // b.show();
}
